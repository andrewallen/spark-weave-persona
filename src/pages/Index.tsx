  ...
  return (
    <div className="crt">
      ...
      <section id="home" className="min-h-screen flex items-center relative scanlines">
        <div className="container mx-auto px-6 pt-32">
          <div className="max-w-3xl">
            <p className="text-[#33FF33] mb-4 animate-fade-in burn-in" data-text="Hi there! I'm">Hi there! I'm</p>
            <h1 className="text-gradient mb-4 animate-slide-down glitch" data-text="Andrew Allen">Andrew Allen</h1>
            <TypewriterText />
            ...
            <div className="flex flex-wrap gap-4 animate-slide-down" style={{
              ...
              <a href="#projects" className="px-6 py-3 bg-[#33FF33] text-navy font-medium rounded-md hover:bg-coral transition-colors duration-300 interactive text-shadow-glow">
                View My Work
              </a>
              <a href="#contact" className="px-6 py-3 border border-[#33FF33] text-[#33FF33] font-medium rounded-md hover:bg-[#33FF33]/10 transition-all duration-300 interactive text-shadow-glow">
                Get In Touch
              </a>
            </div>
          </div>
          ...
          <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 animate-pulse-slow">
            <div className="w-6 h-10 rounded-full border-2 border-[#33FF33] flex items-start justify-center p-1">
              <div className="w-1 h-2 bg-[#33FF33] rounded-full animate-slide-down" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="about" className={`py-24 relative scanlines ${isVisible.about ? 'animate-fade-in' : 'opacity-0'}`}>
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="section-title chromatic-aberration" data-text="About Me">About Me</h2>
              <p className="mb-4">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-[#33FF33] rounded-full flex items-center justify-center text-navy font-bold z-10 border-4 border-navy animate-spin-slow">
              ...
              <div className="absolute -z-10 inset-0 transform -translate-x-4 -translate-y-4 border-2 border-[#33FF33] rounded-lg" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="projects" className={`py-24 relative scanlines ${isVisible.projects ? 'animate-fade-in' : 'opacity-0'}`}>
        <div className="container mx-auto px-6">
          <h2 className="section-title chromatic-aberration" data-text="Featured Projects">Featured Projects</h2>
          ...
          <div className="mt-12 text-center">
            <a href="#" className="inline-flex items-center text-[#33FF33] hover:text-coral transition-colors duration-300 group interactive text-shadow-glow">
              View All Projects
      ...
      {/* Footer */}
      <footer className="py-8 border-t border-[#33FF33]/10 scanlines">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-[#33FF33]/70">
              © {new Date().getFullYear()} Andrew Allen. All rights reserved.
            </p>
            <p className="text-[#33FF33]/70 mt-2 md:mt-0">
